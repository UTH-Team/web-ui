...
export const SignUpContainer = styled.div<SignInContainerProps>`
    position: absolute;
    top: 0;
    height: 100%;
...
export default { Container, SignUpContainer, SignInContainer, Form, Title, Input, Button, GhostButton, Anchor, OverlayContainer, Overlay, OverlayPanel, LeftOverlayPanel, RightOverlayPanel, Paragraph };
